...
//
//void add_stu(){
//    ofstream file("add_student.txt");
//    string name;
//    cout<<"enter 5 student name \n";
//    for (int i = 0; i<5; i++){
//    cout<<"student"<<i + 1<<":";cin>>name;
//    file<<name<<endl;
//
//}
//
...
string stu_name, search_name,new_name;
...
void update(){
    ...
    while(file>>stu_id>>stu_name>>stu_age>>stud_year_level>>stu_score){
        ...
        tempp<<new_id <<" "<<new_name<<" "<<new_age<<" "<<new_year_level<< " "<<new_score<<endl;

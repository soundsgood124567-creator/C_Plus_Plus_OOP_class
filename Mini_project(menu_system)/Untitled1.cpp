...
switch (main_menu){
	case 1 :{
		...
		cin>>sub_menu;
			switch(sub_menu){
					case 1 :{
				cout<<"Pork added to the bill.";
				
			}case 2 :{
				cout<<"Steak added to the bill.";
				break;
			}case 3 :{
			cout<<"Chicken added to the bill.";
			break;
			}case 4:{
				cout<<"Salmon added to the bill";
				break;
		...
		break;
			...
			switch(sub_menu){
				case 1:{
					cout<<"\t\t\t\t\tWater added to the bill.";
					break;
				}case 2 :{
					cout<<"\t\t\t\t\tCoke added to the bill.";
				break;
				}case 3 :{
					cout<<"\t\t\t\t\tSprite added to the bill.";
				break;
				} case 4:{
					cout<<"\t\t\t\t\tFanta added to the bill. ";
					break;
				}case 5:{
					cout<<"\t\t\t\t\tWater melon juice added to the bill.";
					break;
				}case 6:{
		...
		break;
			...
			switch(sub_menu){
				case 1:{
					cout<<"\t\t\t\t\tMango added to the bill.";
					break;
				}
				case 2:{
					cout<<"\t\t\t\t\tWater melon added to the bill.";
					break;
				}
				case 3:{
					cout<<"\t\t\t\t\tWater melon added to the bill.";
				...
				case 4:{
					cout<<"\t\t\t\t\tMango ice cream added to the bill.";
					break;
				}
				case 5 :{
					cout<<"\t\t\t\t\tVanilla ice cream added the to bill.";
